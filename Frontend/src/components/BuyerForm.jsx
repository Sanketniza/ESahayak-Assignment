...
const BuyerForm = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-card rounded-xl shadow-md">
      <h1 className="text-2xl font-semibold mb-6 text-foreground">Create New Buyer Lead</h1>
      
      {serverError && (
        <div className="mb-6 p-4 bg-destructive text-destructive-foreground rounded-md border border-destructive-foreground">
          {serverError}
        </div>
      )}
  ...
  <div className="bg-secondary p-4 rounded-md">
        ...
        <div className="flex justify-end space-x-4">
          ...
          <button
            ...
            className={`px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-primary-foreground bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
